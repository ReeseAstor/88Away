...
const promptsData = [
  ...
  {
    title: "Client Voice Replication Mastery",
    content: "Perfect voice matching: study their writing samples extensively, identify sentence patterns, note vocabulary preferences, capture their unique rhythm. Practice until you can write in their voice instinctively.",
    category: "Ghostwriting",
    subcategory: "Voice Matching",
    tags: ["ghostwriting", "voice", "replication", "mastery"],
    persona: "coach",
    targetRole: "ghostwriter",
    isFeatured: true,
  },
  {
    title: "Subject Matter Expert Development",
    content: "Become an expert in your client's field: immerse yourself in industry publications, interview experts, learn terminology, understand nuances. Your credibility depends on authentic expertise.",
    category: "Ghostwriting",
    subcategory: "Research",
    tags: ["ghostwriting", "expertise", "research", "credibility"],
    persona: "coach",
    targetRole: "ghostwriter",
    isFeatured: false,
  },
  {
    title: "Collaborative Outline Process",
    content: "Build outline with client: extract their knowledge through targeted questions, organize their ideas logically, get buy-in at each stage. Collaboration ensures the book reflects their vision.",
    category: "Ghostwriting",
    subcategory: "Collaboration",
    tags: ["ghostwriting", "outline", "collaboration", "process"],
    persona: "any",
    targetRole: "ghostwriter",
    isFeatured: false,
  },
  {
    title: "Attribution and Credit Boundaries",
    content: "Clarify credit early: Will you be acknowledged? Is this completely anonymous? Can you use it in portfolio? Set clear expectations before starting work.",
    category: "Ghostwriting",
    subcategory: "Ethics",
    tags: ["ghostwriting", "attribution", "credit", "boundaries"],
    persona: "coach",
    targetRole: "ghostwriter",
    isFeatured: false,
  },
  ...
  },
  {
    ...
    content: "Boost newsletter engagement: compelling subject lines, personal tone, valuable content, clear CTAs, mobile-friendly formatting. Track open rates and adjust strategy.",
    category: "Self-Publishing & Marketing",
    subcategory: "Email Marketing",
    tags: ["marketing", "newsletter", "engagement", "email"],
    persona: "coach",
    targetRole: "all",
    isFeatured: true,
  },
  {
    ...
    content: "Optimize Amazon keywords: research competitors, use long-tail phrases, include genre terms, test and iterate. Keywords are how readers discover your book.",
    category: "Self-Publishing & Marketing",
    subcategory: "Amazon Optimization",
    tags: ["marketing", "Amazon", "keywords", "discoverability"],
    persona: "any",
    targetRole: "publisher",
    isFeatured: false,
  },
  {
    title: "Reader Magnet Optimization",
    content: "Create irresistible reader magnet: solve reader problem, showcase your writing, lead naturally to series, deliver professionally. Give real value, not scraps.",
    category: "Self-Publishing & Marketing",
    subcategory: "List Building",
    tags: ["marketing", "reader magnet", "freebie", "value"],
    persona: "coach",
    targetRole: "all",
    isFeatured: false,
  },
  {
    title: "Launch Week Coordination",
    content: "Coordinate launch week: pre-orders ready, ARCs distributed, marketing materials prepared, street team activated, email sequence scheduled. Make launch day explosive.",
    category: "Self-Publishing & Marketing",
    subcategory: "Book Launch",
    tags: ["marketing", "launch week", "coordination", "timing"],
    persona: "coach",
    targetRole: "publisher",
    isFeatured: true,
  },
  ...
  {
    title: "Comp Title Research Strategy",
    content: "Choose comp titles carefully: recent releases (last 2-3 years), similar genre/audience, successful but not mega-bestsellers. Show you know your market and where your book fits.",
    category: "Publishing Prep",
    subcategory: "Market Research",
    tags: ["publishing", "comp titles", "comparisons", "market"],
    persona: "coach",
    targetRole: "all",
    isFeatured: true,
  },
  {
    title: "Query Letter Personalization",
    content: "Personalize every query: mention agent's specific client or stated interest, explain why they're right fit for your book. Generic queries get rejected.",
    category: "Publishing Prep",
    subcategory: "Query Letters",
    tags: ["publishing", "personalization", "query", "research"],
    persona: "coach",
    targetRole: "all",
    isFeatured: false,
  },
  {
    title: "Agent Wishlist Alignment",
    content: "Study agent MSWL (manuscript wishlists): what they're actively seeking, what they're tired of, what excites them. Submit when your manuscript matches their current interests.",
    category: "Publishing Prep",
    subcategory: "Agent Research",
    tags: ["publishing", "wishlist", "targeting", "timing"],
    persona: "any",
    targetRole: "all",
    isFeatured: false,
  },
  {
    title: "Synopsis Emotional Arc",
    content: "Synopsis should capture emotional journey, not just plot events. Show character transformation, emotional beats, why readers will care. Make the agent feel the story.",
    category: "Publishing Prep",
    subcategory: "Synopsis",
    tags: ["publishing", "synopsis", "emotion", "character arc"],
    persona: "muse",
    targetRole: "all",
    isFeatured: true,
  },
